...
public interface Multimap<K, V>
{
     ...
     * appended to the list of old values. Throws: NullPointerException - if the
     * specified key or value is null IllegalStateException - if the value is
     * already associated with key (no duplicate values)
     * 
     * @param key
     ...
     * this map contains no mapping for the key. Throws: NullPointerException -
     * if the specified key is null.IllegalStateException - if the key is not in
     * the multimap.
     * 
     * @param key
     ...
     * specified value. Throws: NullPointerException - if the specified key or
     * oldValue or newValue is null. IllegalStateException - if the key is not
     ...
     * its associated values are removed. Throws: NullPointerException - if the
     * specified key is null. IllegalStateException - if key is not in the
     * multimap
     * 
     * @param key
